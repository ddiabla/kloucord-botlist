...
module.exports = class extends Command {
    ...
    async run(message, [user]) {
        if (!user || !user.bot) return message.channel.send(`No encuentro ese famoso bot llamado "".`);
        ...
        owners.forEach(o => {
            ...
            o.send(`Tu bot \`${bot.username}\` ha sido aprobado.`)
        })
        ...
        message.channel.send(`Aprovado! \`${bot.username}\``);
    }
